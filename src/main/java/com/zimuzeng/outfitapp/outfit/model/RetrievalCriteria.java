 ...
 *
 * @param occasions candidate occasions; empty means no occasion filter
 ...
 * @param minFormality inclusive lower bound (1-5) on formality
 * @param maxFormality inclusive upper bound (1-5) on formality
 * @param warmth preferred warmth, or {@code null} for no preference
